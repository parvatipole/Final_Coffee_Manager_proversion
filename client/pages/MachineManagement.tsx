...
export default function MachineManagement() {
  ...
  const updateSupply = (
    supply: keyof MachineData["supplies"],
    value: number,
  ) => {
    setMachineData((prev) => ({
      ...prev,
  ...
  const updateMaintenance = (
    field: keyof MachineData["maintenance"],
    value: any,
  ) => {
    setMachineData((prev) => ({
      ...prev,
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <Badge
                  className={`${getStatusColor(machineData.status)} text-white`}
                >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Current ingredient and supply status
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                {Object.entries(machineData.supplies).map(
                  ([supply, percentage]) => (
                    <div key={supply} className="space-y-2">
                      ...
                      {isEditing && canEdit ? (
                        <Input
                          ...
                          onChange={(e) =>
                            updateSupply(
                              supply as keyof MachineData["supplies"],
                        ...
                        <Progress
                          value={percentage}
                          className={`h-2 ${getSupplyColor(percentage)}`}
                        />
                      )}
                    </div>
                  ),
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Equipment health and maintenance info
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="capitalize text-sm">
                        {machineData.maintenance.filterStatus.replace("_", " ")}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="capitalize text-sm">
                        {machineData.maintenance.cleaningStatus.replace(
                          "_",
                          " ",
                        )}
                      </span>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-3 gap-4 text-center">
                  ...
                  <div className="space-y-1">
                    <p className="text-2xl font-bold text-primary">
                      {machineData.usage.weeklyCups}
                    </p>
                    <p className="text-sm text-muted-foreground">This Week</p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-2xl font-bold text-primary">
                      ${machineData.usage.monthlyRevenue}
                    </p>
