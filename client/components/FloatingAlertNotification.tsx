...
const FloatingAlertNotification: React.FC<FloatingAlertNotificationProps> = ({ onViewAlerts }) => {
    ...
    <div className="fixed bottom-4 right-4 z-50 max-w-sm">
      <AnimatePresence>
        {activeAlerts.slice(0, 2).map((alert, index) => (
          ...
          >
            <Card className={`border-l-4 shadow-lg hover:shadow-xl transition-all duration-300 ${getAlertColor(alert.type)}`}>
