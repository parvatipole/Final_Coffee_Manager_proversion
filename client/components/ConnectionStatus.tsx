    ...
    return (
      <div className={`flex items-center gap-2 ${className}`}>
        ...
        <div className="flex items-center gap-1">
          ...
          <div className={`w-2 h-2 rounded-full ${getStatusColor(mqttStatus)}`} />
        </div>
        {(backendStatus === 'disconnected' || mqttStatus === 'disconnected') && (
          <Button
            variant="ghost"
            size="sm"
  ...
  return (
    <Card className={className}>
      <CardHeader className="pb-3">
        ...
        <CardDescription>Backend API and real-time communication status</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <div className="flex items-center justify-between p-3 bg-muted/30 rounded-lg">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Spring Boot Server</p>
            </div>
          </div>
        ...
        <div className="flex items-center justify-between p-3 bg-muted/30 rounded-lg">
          <div className="flex items-center gap-3">
            {mqttStatus === 'connected' ? <Wifi className="w-5 h-5" /> : <WifiOff className="w-5 h-5" />}
            <div>
              <p className="font-medium">Real-time Updates</p>
              <p className="text-sm text-muted-foreground">MQTT Communication</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
        ...
        {(backendStatus === 'disconnected' || mqttStatus === 'disconnected') && (
          <Alert>
            ...
            <AlertDescription>
              Some services are unavailable. The app will work in offline mode with limited functionality.
              <Button
                variant="outline"
                size="sm"
                onClick={retryConnections}
